...
A versão atual do plugin é **2.0.7-beta-2**. Nesta linha, a VPN WireGuard/WireSock é
...
checkout do Equicord/Vencord. A release usa `2.0.7-beta-2`; a tag GitHub acrescenta
apenas o prefixo `v`.
